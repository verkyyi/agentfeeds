...
python3 scripts/agentfeeds.py admin templates scaffold local_command personal/status
python3 scripts/agentfeeds.py admin templates approve-command personal/status
python3 scripts/agentfeeds.py admin templates validate
python3 scripts/agentfeeds.py admin templates test personal/status --json
```
